      ...
      <div className='border h-[350px] w-[308px] p-4 mt-[3%]  border border-gray-300  flex flex-col gap-2'>
           ...
           <div className='flex justify-between'>
            ...
            <div className='flex justify-between mt-4 text-red-700 font-bold'>
              ...
              <button onClick={()=> (handlePlaceOrder() ,navigate('/orderHistory'))} className={`bg-amber-400 p-2 mt-7 rounded-[10px] ${cart.length < 1 && ' pointer-events-none opacity-50'} `}>Place your order</button>
